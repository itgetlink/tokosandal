      ...
      <div class="box">
        ...
        <div class="box-body">
		 ...
		 <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">From Edit Produk</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" id="editProduk" action="javascript:void(0)">
              <div class="box-body">
                
				<div class="form-group">
                    <input  class="form-control" id="idProduk" name="idProduk" type="hidden" value="<?php echo $data[0]['ID']?>" />
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input class="form-control" id="namaProduk" name="namaProduk" placeholder="namaProduk" type="text" value="<?php echo $data[0]['NAMA_PRODUK']?>" />
                  </div>
                </div>
				<div class="form-group">
                  <label for="hargaProduk" class="col-sm-2 control-label">Harga Produk</label>
                  <div class="col-sm-10">
                    <input class="form-control" id="hargaProduk" name="hargaProduk" placeholder="hargaProduk" type="text" value="<?php echo $data[0]['HARGA']?>"/>
                  </div>
                </div>
				<div class="form-group">
                  <label for="keterangan" class="col-sm-2 control-label">Keterangan</label>
				  <div class="col-sm-10">
					<textarea class="form-control" name="keterangan" id="keterangan" rows="3" placeholder="Enter ..."><?php echo $data[0]['KETERANGAN']?></textarea>
				  </div>
                </div>
				<div class="form-group">
...
$(document).ready(function() {
    console.log( "ready!" );
	$('#spinner').hide();
	$('#typeProduk').val('<?php echo $data[0]['TYPE_PRODUK']?>');
	//aa();	
});

// function save(){
$("form#editProduk").submit(function(event){
