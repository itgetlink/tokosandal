						...
						<h4>For More <span>Information</span></h4>
							<div class="mail-agileits-w3layouts">
								...
								<div class="contact-right">
									<p>Telephone </p><span>+62813-2112-3403</span>
								</div>
							...
							<div class="mail-agileits-w3layouts">
								...
								<div class="contact-right">
									<p>Email </p><a href="mailto:info@example.com">bearpath.sandal@gmail.com</a>
								</div>
								<div class="clearfix"> </div>
							</div>
							<div class="mail-agileits-w3layouts">
								...
								<div class="contact-right">
									<p>Location</p><span>Jl. H. Mesri No. 28c, Pasir Kaliki, Cicendo, <br/>Bandung, Jawa Barat, Indonesia.</span>
								</div>
								<div class="clearfix"> </div>
							</div>
					</div>
